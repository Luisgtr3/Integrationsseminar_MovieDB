...
public class MovieControllerImplTest {
    ...
    public void setUp(){
        ...
        movie_2 = new MovieDTO(2L,
                ...
                9.0,
                List.of(1L,2L),
                List.of(oscar_2, oscar_3));

        this.movieList = List.of(movie_1, movie_2);
    }


    @Test
    public void shouldSucessfullyReturnAllMovies() throws Exception{
    ...
    @Test
    public void shouldSucessfullyReturnMovie() throws Exception{
    ...
    @Test
    public void shouldSucessfullyRemoveMovie() throws Exception{
    ...
    @Test
    public void shouldSucessfullyAddMovie() throws Exception{
    ...
    @Test
    public void shouldFailGetMovie() throws Exception{
        when(movieService.getMovieById(anyLong())).thenThrow(new NoSuchElementException("No movie found for id"));

        this.mockMvc.perform(get(controllerPath+"/20"))
                .andExpect(status().isNotFound());

        verify(movieService).getMovieById(20L);
    }

    @Test
    public void shouldSuccessfullyUpdateMovie() throws Exception{
    ...
    @Test
    public void shouldFailUpdateMovieBecauseConstraintViolation() throws Exception{

        movie_1.setTrailerUrl(null);

        this.mockMvc.perform(put(controllerPath+"/1")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(this.objectMapper.writeValueAsString(movie_1))).andExpect(status().isBadRequest());

        verify(movieService, never()).updateMovie(any());
    }


    @Test
    public void shouldFailUpdateMovieBecauseUnknownId() throws Exception{

        when(movieService.updateMovie(any())).thenThrow(new EntityNotFoundException("MovieId does not exist"));
